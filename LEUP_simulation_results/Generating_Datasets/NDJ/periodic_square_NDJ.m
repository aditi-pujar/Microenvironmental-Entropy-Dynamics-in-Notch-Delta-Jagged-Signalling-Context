...
%% Save the data here:
foldername = '../../Datasets/NDJ';
filename = strcat('control300_D0_',num2str(D0),'_J0_',num2str(J0),'_t',num2str(seed),'.mat');
...
save(fullfile(cd,foldername,filename),'N','D','I','J','T','kTD','kTJ','kC','ldf','N0','D0','J0','I0')
toc
end