...
xticklabels(strcat(string(num2cell(floor(jqplot(my_ticks))))));
yticklabels(strcat(string(num2cell(fliplr(floor(dqplot(my_ticks))))))); 
print('fig7__modality_index.eps','-depsc');
...
print('fig7__bimodal_representative.eps','-depsc');
...
print('fig7__unimodal_representative.eps','-depsc');
